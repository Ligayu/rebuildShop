<template>
	<view>
		<uni-swipe-action>
		    <!-- 基础用法 -->
		    <uni-swipe-action-item :right-options="options" :left-options="options" @click="onClick" @change="swipeChange">
		...
		<!-- 按组使用 -->
		<uni-swipe-action>
		    <uni-swipe-action-item :right-options="options" v-if='isShow'  @click="onClick" @change="swipeChange(event, index)">
		        <view >item1</view>
		    </uni-swipe-action-item>
